    ...
    <section ref={containerRef} className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-28 md:pt-32">
        ...
        <motion.div
          ...
          className="relative inline-flex items-center gap-1.5 bg-gradient-to-r from-gold-600/90 via-gold-500/95 to-gold-600/90 backdrop-blur-md border border-gold-400/60 rounded-full px-5 py-2 mb-8 overflow-hidden group shadow-gold"
        >
          {/* Shimmer effect */}
          <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/30 to-transparent" />
          <span className="text-sm relative z-10">🍫</span>
          <span className="text-chocolate-950 font-body text-xs tracking-[0.15em] font-bold uppercase relative z-10">
            Proposta Exclusiva
          </span>
          <span className="text-sm relative z-10">🍫</span>
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-chocolate-950 via-chocolate-950/60 to-transparent pointer-events-none" />
    </section>
  );
};
